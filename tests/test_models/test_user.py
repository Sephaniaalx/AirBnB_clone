...
class TestUser_instantiation(unittest.TestCase):
    """This unittests is for testing instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """This unittests is for testing save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """This unittests is for testing to_dict method of the User class."""
